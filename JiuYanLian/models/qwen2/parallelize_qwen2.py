...
from JiuYanLian.config_manager import JobConfig, TORCH_DTYPE_MAP
from JiuYanLian.logging import logger
from JiuYanLian.parallelisms.parallel_dims import ParallelDims
from JiuYanLian.parallelisms.utils import check_if_feature_in_pytorch
...
def apply_ac(model: nn.Module, ac_config):
    ...
    for layer_index in range(len(model.model.layers)):
        model.model.layers[layer_index] = _apply_ac_to_transformer_block(model.model.layers[layer_index], ac_config)
...
def apply_compile(model: nn.Module):
    ...
    for layer_index in range(len(model.model.layers)):
        model.model.layers[layer_index] = torch.compile(model.model.layers[layer_index], fullgraph=True)
