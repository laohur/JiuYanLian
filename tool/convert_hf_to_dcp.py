# https://github.com/pytorch/torchtitan/issues/305
import json
import re
import sys
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hf2dcp', type=bool, default=True)

    args = parser.parse_args()
    convert_hf2dcp_checkpoint(
...
"""
python scripts/convert_hf_to_dcp.py \
    --checkpoint Llama-2-7b-hf \
    --output outputs/Llama-2-7b-hf-auto-dcp
python scripts/convert_hf_to_dcp.py \
    --checkpoint outputs/checkpoint/step-1000  \
    --output outputs/Llama-2-7b-hf-dcp2hf \
    --hf2dcp False
python -m torch.distributed.checkpoint.format_utils dcp_to_torch torchtitan/outputs/checkpoint/step-1000 checkpoint.pt
python -m torch.distributed.checkpoint.format_utils dcp_to_torch outputs/checkpoint/step-1000 outputs/Llama-2-7b-hf-dcp2hf/checkpoint.pt
